...
// Get URL for current role or fallback
...
?>
   <nav class="navbar bg-base-100 shadow-md px-4 py-3">
        ...
        <div class="flex-none hidden lg:flex items-center gap-4">
            <!-- Status Counters -->
            <div class="flex items-center gap-3 bg-base-200 rounded-lg px-4 py-2 hidden">
...
<li>
    <a href="<?php echo $homeUrl; ?>" class="flex items-center gap-2 py-2">
