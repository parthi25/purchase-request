...
<?php include '../common/layout.php'; ?>
    ...
    <div class="card bg-base-100 shadow-xl mb-6">
        <div class="card-body">
            ...
            <form id="buyerMappingForm" class="flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-end gap-3">
...
function loadMappings(page = 1, search = '') {
            ...
            tbody.html(mappings.map(row => `
                <tr>
                    ...
                    <td>
                        <div class="flex gap-2">
    <button
        class="btn btn-ghost btn-sm text-primary hover:bg-transparent edit-btn"
        data-id="${row.id}"
        title="Edit"
    >
    ...
    <button
        class="btn btn-ghost btn-sm text-error hover:bg-transparent delete-btn"
        data-id="${row.id}"
        title="Delete"
    >
