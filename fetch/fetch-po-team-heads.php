...
try {
    // Try PO_Head first, then PO_Team as fallback
    $query = "SELECT u.id, u.username FROM users u INNER JOIN roles r ON u.role_id = r.id WHERE (r.role_code = 'PO_Head' OR r.role_code = 'PO_Team') AND u.is_active = 1 ORDER BY u.username";
